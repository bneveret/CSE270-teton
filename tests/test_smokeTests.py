...
class TestSmokeTests():
  ...
  def test_adminPage(self):
    ...
    self.driver.set_window_size(1300, 1047)
    elements = self.driver.find_elements(By.ID, "username")
    assert len(elements) > 0
    self.driver.find_element(By.ID, "username").click()
    self.driver.find_element(By.ID, "username").send_keys("jerry")
    self.driver.find_element(By.ID, "password").click()
    self.driver.find_element(By.ID, "password").send_keys("spacefield")
  ...
  def test_joinPage(self):
    ...
    self.driver.find_element(By.NAME, "bizname").send_keys("carls")
